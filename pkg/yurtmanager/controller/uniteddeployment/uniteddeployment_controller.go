...
import (
	...
	"github.com/openyurtio/openyurt/pkg/yurtmanager/controller/uniteddeployment/adapter"
	"github.com/openyurtio/openyurt/pkg/yurtmanager/controller/util/gate"
)
...
var (
	...
	controllerResource   = unitv1alpha1.SchemeGroupVersion.WithResource("uniteddeployments")
)
...
func Add(ctx context.Context, cfg *appconfig.CompletedConfig, mgr manager.Manager) error {
	...
	return add(mgr, newReconciler(cfg, mgr))
}
...
func newReconciler(c *appconfig.CompletedConfig, mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileUnitedDeployment{
		...
		recorder: mgr.GetEventRecorderFor(names.UnitedDeploymentController),
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	c, err := controller.New(names.UnitedDeploymentController, mgr, controller.Options{Reconciler: r, MaxConcurrentReconciles: concurrentReconciles})
	if err != nil {
		return err
	}
...
func (r *ReconcileUnitedDeployment) calculateStatus(instance *unitv1alpha1.UnitedDeployment, newStatus *unitv1alpha1.UnitedDeploymentStatus,
	...
	if poolFailure == nil {
		RemoveUnitedDeploymentCondition(newStatus, unitv1alpha1.UdPoolFailure)
	} else {
		SetUnitedDeploymentCondition(newStatus, NewUnitedDeploymentCondition(unitv1alpha1.UdPoolFailure, corev1.ConditionTrue, "Error", *poolFailure))
	}
